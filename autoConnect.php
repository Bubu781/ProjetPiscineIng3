<?php
	if(!isset($_SESSION['ID_people']) && isset($_COOKIE['pseudo']) && isset($_COOKIE['password']) && (!isset($_SESSION['deconnection']) || !$_SESSION['deconnection'])){
		$result = sendRequest("SELECT Id FROM People WHERE Pseudo = '" . $_COOKIE['pseudo'] . "' AND Mot_De_Passe = '" . $_COOKIE['password'] . "'");
