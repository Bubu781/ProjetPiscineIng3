...
<body>
	<?php
		include("header.php");
	?>
	<form action="traitementNewPeople.php" method="post">
		...
		<div id="formulaireDown" >
			...
			<tr class="form-group">
				<td align="center"><input class="form-control" type="submit" name="Valider"></td>
				<td align="center"><input class="form-control" type="reset" name="Réinitialiser"></td>
			</tr>
